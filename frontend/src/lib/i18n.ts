...
export const translations = {
  ...
  pt: {
    ...
    seriesHints: {
      bcb_432: 'Taxa básica de juros definida pelo Banco Central. SELIC mais alta encarece o crédito e freia a inflação; mais baixa estimula empréstimos e o crescimento.',
      bcb_433: 'Índice oficial de preços ao consumidor, medido mês a mês. Valores positivos indicam alta de preços; acima de ~0,5% ao mês sinaliza pressão inflacionária forte.',
      bcb_1: 'Quantos reais um dólar americano compra. Taxa em alta significa que o real está perdendo valor, encarecendo importações.',
